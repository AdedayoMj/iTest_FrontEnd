            ...
            <div className={classes.paper}>
                ...
                <form className={classes.form}>
                    <Grid container spacing={2}>
                        <Grid item xs={12}>
                            <TextField autoComplete="fname" name="displayName" variant="outlined" required fullWidth id="displayName" label="Username" autoFocus />
                        </Grid>
                        ...
                        <Grid item xs={12}>
                            <TextField variant="outlined" required fullWidth id="confirmPassword" label="Confrim Password" name="confirmPassword" type="password" />
                        </Grid>
                        <Grid item xs={12}>
